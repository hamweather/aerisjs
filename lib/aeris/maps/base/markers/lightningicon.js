define(['aeris', './icon'], function(aeris) {
  ...
  aeris.provide('aeris.maps.markers.LightningIcon');
   ...
   */
  aeris.maps.markers.LightningIcon =
      function(position, timestamp, opt_options) {

    aeris.maps.markers.Icon.call(this, position,
        aeris.config.path + 'assets/lightning_white.png', 15, 34, opt_options);
  ...
  aeris.inherits(aeris.maps.markers.LightningIcon, aeris.maps.markers.Icon);
  ...
  aeris.maps.markers.LightningIcon.prototype.setTimestamp =
    ...
    this.url = aeris.config.path + 'assets/' + this.urlAges_[this.age_] + '.png';
  };
