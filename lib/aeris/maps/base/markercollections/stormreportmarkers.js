define([
   ...
   * @override
   */
  aeris.maps.markerCollections.StormReportMarkers.prototype.
      getMarkerData = function(bounds) {
    return aeris.AerisAPI.getInstance().getStormReportData(
      bounds, {
   ...
   * @overrides
   */
  aeris.maps.markerCollections.StormReportMarkers.prototype.generateMarker =
   ...
   */
  aeris.maps.markerCollections.StormReportMarkers.prototype.setHours =
      function(hours) {
    this.hours_ = hours;
   ...
   */
  aeris.maps.markerCollections.StormReportMarkers.prototype.setTypes =
      function(types) {
    this.types_ = types;
   ...
   * @override
   */
  aeris.maps.markerCollections.StormReportMarkers.prototype.filterMarker =
      function(marker) {
