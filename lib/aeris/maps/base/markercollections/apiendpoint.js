define([
  ...
  aeris.provide('aeris.maps.markercollections.APIEndpoint');
  ...
  aeris.inherits(aeris.maps.markercollections.APIEndpoint,
                 aeris.maps.MarkerCollection);
  aeris.extend(aeris.maps.markercollections.APIEndpoint.prototype,
   ...
   *     Defaults to true.
   * @returns {aeris.Promise} A promise to fetch and resolve with Markers.
   */
   ...
   *
   * @returns {aeris.Promise} A promise to fetch raw marker data from the API
